...
## schwarzesmarken is replaced with черные метки to reduce the number of different languages. Lise hohenstein is also replaced with Лиза Хохенштейн
...
######Naoto has a unique ability to attract very powerful girls.
